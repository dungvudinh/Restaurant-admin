...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2024 at 09:22 AM
...
(18, '0869370492', '$2a$10$QbfXTiie0y8J330V33WGU.8OTKu0JNe6Yj.3rUSS1K17Jg11icLR.'),
...
(117, 54, 3, '[{\"order_menu_id\":10,\"order_menu_note\":\"\",\"order_menu_quantity\":1},{\"order_menu_id\":21,\"order_menu_note\":\"\",\"order_menu_quantity\":1},{\"order_menu_id\":20,\"order_menu_note\":\"\",\"order_menu_quantity\":1},{\"order_menu_id\":33,\"order_menu_note\":\"\",\"order_menu_quantity\":1},{\"order_menu_id\":35,\"order_menu_note\":\"\",\"order_menu_quantity\":1}]', 1, '', 1, NULL, '2024-05-17 11:39:39', NULL, NULL, 1, 'HD000011', 11),
(120, NULL, 1, '[{\"order_menu_id\":5,\"order_menu_note\":\"\",\"order_menu_quantity\":2},{\"order_menu_id\":34,\"order_menu_note\":\"\",\"order_menu_quantity\":1},{\"order_menu_id\":22,\"order_menu_note\":\"\",\"order_menu_quantity\":2},{\"order_menu_id\":10,\"order_menu_note\":\"\",\"order_menu_quantity\":1}]', 1, '', 1, NULL, '2024-05-17 11:58:49', NULL, NULL, 1, 'HD000014', 14),
(121, NULL, 4, '[{\"order_menu_id\":5,\"order_menu_note\":\"\",\"order_menu_quantity\":1},{\"order_menu_id\":34,\"order_menu_note\":\"\",\"order_menu_quantity\":1},{\"order_menu_id\":33,\"order_menu_note\":\"\",\"order_menu_quantity\":1},{\"order_menu_id\":22,\"order_menu_note\":\"\",\"order_menu_quantity\":1}]', 1, '', 1, NULL, '2024-05-17 12:04:14', NULL, NULL, 1, 'HD000015', 15);
...
(1, 'Bàn số 1', 4, 'Bàn dành cho 4 người kkk', 1, '2024-05-01 14:05:32', NULL, NULL, 1, 1),
(2, 'Bàn số 2', 5, 'Bàn dành cho khách vip hihi', 0, '2024-05-02 15:43:57', NULL, NULL, 1, 1),
(3, 'Bàn số 3', 4, 'Bàn dành cho gia đình', 1, '2024-05-02 15:44:22', NULL, NULL, 2, 1),
...
CREATE TABLE `user` (
  ...
  `full_name` varchar(30) NOT NULL,
  `role` int(11) NOT NULL COMMENT 'role = 1: admin, role= 2: Lễ tân, thu ngân'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `user` (`id`, `account_id`, `full_name`, `role`) VALUES
(1, 16, 'Vũ Đình Dũng', 1),
(2, 18, 'Bùi Việt Hoàng ', 2),
(3, 19, 'Đỗ Văn Linh', 2);
